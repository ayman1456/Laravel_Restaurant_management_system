...
<div class="col-lg-8  mx-auto mt-5">
    <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mx-auto " style="width:fit-content">
            ...
            <div class="my-2">
                <input type="text" placeholder="Name" name="name" value="{{ auth('customer')->user()->name }}"
            ...
            <div class="buttom mx-auto" style="width: fit-content">
                <button class="my-2 mx-auto"
                    style="background-color: #f7ad1d;color:black;padding:5px 20px 5px 20px; border:0px;border-radius:10px;color:white">Save
                    changes</button>
            </div>
        </div>

...
<body class="bg-light">
            ...
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            <h6 class="my-0">{{ $item->food->title }}</h6>
                            <small class="text-muted">{{ $item->qty }} * {{ $item->food->price }}</small>
                        </div>
                        <span class="text-muted">{{ $price = $item->qty * $item->food->price}}</span>
                    </li>
                    @php
                    $total += $price;
                    @endphp
                    ...
                    <li class="list-group-item d-flex justify-content-between " style="border-bottom: none">
                        <span>Delivery </span>
                        <strong>{{ $settings->delivery }} TK</strong>
                    </li>
                    <li class="list-group-item d-flex justify-content-between" style="border-top: none">
                        <span>Subtotal </span>
                        <strong>{{ $total }} TK</strong>
                    </li>
                    <li class="list-group-item d-flex justify-content-between">
                        <span>Total (BDT)</span>
                        <strong>{{ $total + $settings->delivery }} TK</strong>
                    </li>
                </ul>
            </div>
    ...
    <script>
        ...
        $('#sslczPayBtn').click(function(){
            ...
            obj.email = $('#email').val();
            obj.addr1 = $('#address').val();
            obj.addr2 = $('#address2').val();
